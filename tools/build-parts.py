...
PNOTE = ('<!-- 이 파일 전체를 해당 페이지의 코드 위젯 하나에 붙입니다. '
         ...
         '각각 따로 맡습니다. -->')
# 파일마다 다른 안내문. 2026-09-02 활동 셋(지자체 감시 /49 · 예산감시 /27 ·
# 시민참여 /51)은 캠페이너스 기본 게시판 위젯을 살리려고 앞 코드와 게시판을
# 따로 둡니다. 그래서 미리보기용 전체 파일을 그대로 붙이면 안 됩니다.
# 밑빠진 독상(/76)은 이 구조에서 제외라 표준 안내문을 그대로 씁니다.
PNOTES = dict(
    ('activity-%s.html' % key,
